...
for(var elmt of position){
    var temp,
        from;
    //AJOUT D'UN EVENEMENT A L'ELEMENT 
    elmt.addEventListener("click", function(e){

        // INDICATION DE TOUR ET OU ON DOIT SE DEPLACER
        if(!turn.classList.contains("moving")) {
            ...
            if(turn.classList.contains("player1")) {
                if(this.classList.contains("p1")) {
                    ...
                    alert("Sélectionner un pion blanc!");
                }
            }
                ...
                if(this.classList.contains("p2")) {
                    ...
                    alert("Sélectionner un pion noir!");
                }
            }
            ...
            if(turn.classList.contains("player1")) {
                ...
                if(this != temp) {
                    if(!this.classList.contains("p1") && !this.classList.contains("p2")
                      && this != temp && isValid(from, this.id)) {
                        moveTo(from, this.id);
